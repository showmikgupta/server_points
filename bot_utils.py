...
def rankLevelXp(user_data):
    if user_data.get_level() == 1:
        return "F5"
    if user_data.get_level() == 2:
        return "F4"
    if user_data.get_level() == 3:
        return "F3"
    if user_data.get_level() == 4:
        return "F2"
    if user_data.get_level() == 5:
        return "F1"
    if user_data.get_level() == 6:
        return "E5"
    if user_data.get_level() == 7:
        return "E4"
    if user_data.get_level() == 8:
        return "E3"
    if user_data.get_level() == 9:
        return "E2"
    if user_data.get_level() == 10:
        return "E1"
    if user_data.get_level() == 11:
        return "D5"
    if user_data.get_level() == 12:
        return "D4"
    if user_data.get_level() == 13:
        return "D3"
    if user_data.get_level() == 14:
        return "D2"
    if user_data.get_level() == 15:
        return "D1"
    if user_data.get_level() == 16:
        return "C3"
    if user_data.get_level() == 17:
        return "C2"
    if user_data.get_level() == 18:
        return "C1"
    if user_data.get_level() == 19:
        return "B3"
    if user_data.get_level() == 20:
        return "B2"
    if user_data.get_level() == 21:
        return "B1"
    if user_data.get_level() == 22:
        return "A3"
    if user_data.get_level() == 23:
        return "A2"
    if user_data.get_level() == 24:
        return "A1"
    if user_data.get_level() == 25:
        return "S2"
    if user_data.get_level() == 26:
        return "S1"
    if user_data.get_level() == 27:
        return "SS"